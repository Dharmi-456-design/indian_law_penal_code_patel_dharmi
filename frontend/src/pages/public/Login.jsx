          ...
          <div className="relative z-10 flex flex-col h-full p-10 lg:p-14">
            ...
            <div className={`mb-6 ${mounted ? 'anim-fade-right' : 'opacity-0'}`} style={{ animationDelay: '0.25s' }}>
              ...
              <p className={`text-[14px] leading-relaxed max-w-[300px] transition-colors duration-300 ${dark ? 'text-gray-400' : 'text-stone-600'}`}>
                Research statutes, cross-reference judgments, and manage case annotations — all in one modern workspace.
              </p>
            </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative bg-white dark:bg-[#0d1117]">
          ...
          <div className={`w-full max-w-[420px] relative z-10 ${mounted ? 'anim-fade-left' : 'opacity-0'}`}
            ...
            <div className="text-center mb-7">
              ...
              <h2 className="text-[28px] font-extrabold text-[#111827] dark:text-white mb-1.5 tracking-tight">Welcome Back</h2>
              <p className="text-[14px] text-gray-500 dark:text-gray-400">Sign in to access your professional legal suite.</p>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden animate-scale-in"
              ...
              <div className="flex border-b border-[#e5e7eb] dark:border-white/8">
                <button id="tab-login" className="flex-1 py-4 text-sm font-bold transition-all"
                  style={{ color: dark ? '#a78bfa' : '#c9a84c', borderBottom: `2px solid ${dark ? '#7c3aed' : '#c9a84c'}` }}>
                  Log In
                </button>
                <Link to="/register" className="flex-1 py-4 text-center text-sm font-semibold text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                  Register
                </Link>
              </div>
              ...
              <div className="p-7">
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-5">
                  ...
                  <div className="flex justify-end">
                    <a href="#" className="text-[12px] font-semibold hover:underline underline-offset-2 transition-colors"
                  ...
                  <button id="google-login" type="button"
                    className="w-full flex items-center justify-center gap-3 py-3 border border-[#d1d5db] dark:border-white/10 rounded-xl text-sm font-medium text-[#374151] dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-200">
                  ...
                  <button id="sso-login" type="button"
                    className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-sm font-semibold transition-all duration-200 hover:opacity-90"
                    style={{
                      background: dark ? 'rgba(201,168,76,0.12)' : '#1e2d4f',
                      color: dark ? '#c9a84c' : '#fff',
                      border: dark ? '1px solid rgba(201,168,76,0.25)' : 'none',
                    }}>
            ...
            <p className="text-center text-[13px] text-gray-500 dark:text-gray-500 mt-2">
              ...
              <Link to="/register" className="font-bold hover:underline underline-offset-2 transition-colors"
                style={{ color: dark ? '#a78bfa' : '#c9a84c' }}>
                Create one
              </Link>
            </p>
