  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-900 text-white">
      <div className="w-full max-w-md rounded-lg bg-slate-800 p-8 shadow-md">
        <h2 className="mb-6 text-center text-3xl font-bold text-amber-500">LexIndia Register</h2>
        <div className="mb-4">
          <label className="block mb-2 text-sm font-medium text-slate-300">Name</label>
          <input className="w-full rounded bg-slate-700 p-2 text-white outline-none focus:ring-2 focus:ring-amber-500" type="text" placeholder="John Doe" />
        </div>
        <div className="mb-4">
