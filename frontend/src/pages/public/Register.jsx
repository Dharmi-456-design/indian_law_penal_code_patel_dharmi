      ...
      <div className="hidden md:flex md:w-[42%] flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <div className="mt-10 space-y-4">
            {[
              { icon: 'library_books', label: 'Access millions of legal judgments' },
              { icon: 'cloud_sync', label: 'Cloud-synced notes across devices' },
              { icon: 'insights', label: 'AI-powered legal analytics' },
            ].map(({ icon, label }) => (
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="bg-white dark:bg-[#1d2021] rounded-2xl overflow-hidden"
            ...
            <div className="flex border-b border-[#e5e7eb] dark:border-[#40484a]">
              ...
              <button className="flex-1 py-4 text-sm font-semibold border-b-2 text-[#c9a84c] dark:text-[#7c3aed] border-[#c9a84c] dark:border-[#7c3aed] transition-colors">
                Register
              </button>
            </div>
            ...
            <div className="p-8">
              <form onSubmit={e => e.preventDefault()}>
                ...
                <div className="mb-5">
                  ...
                  <input id="register-email" name="email" type="email" value={formData.email}
                ...
                <div className="mb-7">
                  ...
                  <div className="relative">
                    <input id="register-confirm" name="confirmPassword"
                ...
                {/* SSO */}
                <button id="sso-register" type="button"
          ...
          <p className="text-center text-[13px] text-[#6b7280] dark:text-[#9ca3af] mt-3">
            ...
            <Link to="/login" className="text-[#c9a84c] dark:text-[#a78bfa] font-semibold hover:underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
